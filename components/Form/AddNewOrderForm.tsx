            ...
            <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
              <div className="w-full xl:w-1/2">
                ...
                <div className="flex items-center gap-4">
                  ...
                  />
                  <button
                    className="inline-flex items-center justify-center gap-3.5 cursor-pointer rounded-md text-white bg-findmyleather py-3 px-4 text-center font-medium transition hover:bg-opacity-90 disabled:cursor-default disabled:text-body disabled:bg-whiter dark:disabled:bg-strokedark lg:px-8 xl:px-10"
                    type="button"
                    onClick={() => {
