...
const OrderTable = ({ UserOrderDetails }: any) => {
            ...
            {tableData?.map((order: any) => (
              <>
                <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                  ...
                  <td className="px-6 py-4">{order.colour}</td>
                  <td className="px-6 py-4">{order.size}</td>
                  <td className="px-6 py-4">{order.thickness}</td>
                  <td className="px-6 py-4">{order.selection}</td>
                  <td className="px-6 py-4">
                    {new Date(order.estimated).toLocaleDateString()}
                  </td>
                  <td className="px-6 py-4">{order.shippingTerms}</td>
                  <td className="px-6 py-4">{order.shippingMethod}</td>
                  <td className="px-6 py-4">{order.paymentTerms}</td>
                  <td className="px-6 py-4">{order.complianceCertificates}</td>
                  <td className="px-6 py-4">{order.specialRequirement}</td>
                  <td className="px-6 py-4">{order.pricePerSqFt}</td>
