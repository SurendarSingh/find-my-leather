...
export const metadata: Metadata = {
  title: "SignUp to FindMyLeather.com",
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="w-full lg:w-1/2">
            <div className="py-6 lg:py-17.5 px-10 text-center">
              ...
              <p className="2xl:px-20">
                India&apos;s first global leather sourcing and procurement
                platform
              </p>

              <span className="mt-15 lg:inline-block hidden">
                <svg
                  width="350"
                  height="350"
                  viewBox="0 0 350 350"
          ...
          <div className="w-full border-stroke dark:border-strokedark lg:w-1/2 lg:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <div className="mb-9 max-lg:text-center">
                <span className="mb-1.5 block font-medium">FindMyLeather</span>
